...
for movimiento in movimientos:
  ...
  for i in range(cuantos_mover -1, -1, -1): # Poner en destino
    pilas[mover_a -1].insert(0, pilas[mover_de -1][i])
  for i in range(cuantos_mover): # Eliminar origen
    pilas[mover_de -1].pop(0)
